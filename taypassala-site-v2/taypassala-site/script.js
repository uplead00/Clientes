...
(function () {
  ...
  function animateCounter(el) {
    ...
    function groupInt(n) {
      return Math.round(n).toLocaleString(currentLang === "en" ? "en-US" : "pt-BR");
    }
    if (prefersReduced) {
      var staticShown = decimals > 0 ? target.toFixed(decimals) : groupInt(target);
  ...
  if (resultsTrack) {
    ...
    function rBuildDots() {
      ...
      for (var i = 0; i < rTotal; i++) {
        ...
        (function (i) {
          d.addEventListener("click", function () { rGoTo(i); rRestartAuto(); });
        })(i);
    ...
    function rUpdate() {
      ...
      rDots.forEach(function (d, i) { d.classList.toggle("is-active", i === rIndex); });
    }
    ...
    function rNext() { rGoTo(rIndex >= rMaxIndex() ? 0 : rIndex + 1); }
    function rPrev() { rGoTo(rIndex <= 0 ? rMaxIndex() : rIndex - 1); }
    ...
    if (resultsNextBtn) resultsNextBtn.addEventListener("click", function () { rNext(); rRestartAuto(); });
    if (resultsPrevBtn) resultsPrevBtn.addEventListener("click", function () { rPrev(); rRestartAuto(); });
    ...
    /* Swipe em toque */
    var rStartX = 0, rDeltaX = 0, rDragging = false;
    resultsViewport.addEventListener("touchstart", function (e) {
      rStartX = e.touches[0].clientX; rDeltaX = 0; rDragging = true;
    }, { passive: true });
    resultsViewport.addEventListener("touchmove", function (e) {
      if (!rDragging) return;
  ...
  var i18n = {
    pt: {
      ...
      "problem.item2": "Já tentou vários métodos, mas nada durou mais de 2 meses",
      "problem.item3": "Sente que está perdendo tempo (e dinheiro) sem orientação certa",
      "problem.item4": 'Faz tudo "certinho" mas não sabe se está no caminho certo',
      "problem.statement":
      ...
      "method.sub": "Quatro pilares que transformam o esforço em resultado real.",
      "method.card1.kicker": '<span class="method__num">01</span> · Estratégia',
      "method.card1.text": "Treino prescrito com base em dados reais. Sem copiar planilha de internet.",
      "method.card2.kicker": '<span class="method__num">02</span> · Individualização',
      "method.card2.text": "Nenhuma aluna recebe o mesmo protocolo. Seu corpo, seu ritmo, sua vida.",
      "method.card3.kicker": '<span class="method__num">03</span> · Constância',
      "method.card3.text": "Acompanhamento contínuo para você não parar no primeiro obstáculo.",
      "method.card4.kicker": '<span class="method__num">04</span> · Saúde',
      "method.card4.text": "100% natural. Performance sem comprometer a sua saúde.",
      /* Planos */
      ...
      "plan4.benefit1": "Avaliação completa do histórico de lesões e limitações",
      "plan4.benefit2": "Treino personalizado para reabilitação funcional e retorno seguro",
      "plan4.benefit3": "Protocolos para tendinopatias e dores musculoesqueléticas",
      "plan4.benefit4": "Fortalecimento de articulações, músculos e tecidos de suporte",
      "plan4.benefit5": "Correção de padrões de movimento e prevenção de novas lesões",
      "plan4.benefit6": "Progressão individual com acompanhamento próximo e ajustes contínuos",
      "plan4.for":
      ...
      "result1.quote": '"Mudei de país e continuei. A Taynara foi o que não mudou."',
      "result1.tag": "Acompanhamento online · 100% natural",
      "result2.time": "8 meses de acompanhamento",
      "result2.quote": '"Pela primeira vez vi o corpo mudar de verdade. E sem fórmula mágica."',
      ...
      "result4.quote": '"Voltei a me sentir bem no meu próprio corpo, com leveza."',
      "result4.tag": "Emagrecimento e recomposição · 100% natural",
      "result5.time": "7 meses de acompanhamento",
      "result5.quote": '"Conquistei definição e glúteo que eu achava impossível."',
      "result5.tag": "Hipertrofia e definição · 100% natural",
      /* Depoimentos */
      "testi.eyebrow": "Depoimentos",
      "testi.title": "Quem treina com a Tay, fica.",
      "testi1.text":
        '"Tinha medo de não funcionar online, mas o acompanhamento é tão próximo que parece presencial. Cada ajuste é pensado pra mim."',
      "testi1.since": "Aluna há 2 anos",
      "testi2.text":
        '"Em 6 semanas já vi diferença real no espelho. A constância que a Tay cobra (com carinho) mudou tudo."',
      "testi2.since": "Aluna há 1 ano",
      "testi3.text":
        '"Sempre achei que não tinha tempo. A Taynara montou um plano que cabe na minha rotina corrida e mesmo assim evoluo."',
      "testi3.since": "Aluna há 3 anos",
      "testi4.text":
        '"Nunca me senti só mais uma. Ela responde, ela acompanha, ela se importa de verdade com o meu resultado."',
      ...
      "forwhom.yes.item3": "Quer hipertrofia, definição ou alta performance de forma natural",
      "forwhom.yes.item4": "Precisa de acompanhamento personalizado, não planilha genérica",
      ...
      "faq.a5": "Sim, para quem está na região de Curitiba-PR. Consulte a disponibilidade de agenda pelo WhatsApp.",
      ...
      /* Footer */
      "footer.about": "Coach de Alta Performance · Personal Trainer<br>Online · Presencial · Curitiba-PR",
    ...
    en: {
      ...
      "problem.item1": "You've been training for months but your body isn't changing the way it should",
      "problem.item2": "You've tried various methods, but nothing lasted more than 2 months",
      "problem.item3": "You feel you're wasting time (and money) without the right guidance",
      "problem.item4": 'You do everything "right" but don\'t know if you\'re on the right track',
      "problem.statement":
      ...
      "method.card1.text": "Training prescribed based on real data. No copying internet spreadsheets.",
      "method.card2.kicker": '<span class="method__num">02</span> · Individualization',
      "method.card2.text": "No two students receive the same protocol. Your body, your pace, your life.",
      "method.card3.kicker": '<span class="method__num">03</span> · Consistency',
      "method.card3.text": "Continuous support so you don't stop at the first obstacle.",
      "method.card4.kicker": '<span class="method__num">04</span> · Health',
      "method.card4.text": "100% natural. Performance without compromising your health.",
      /* Plans */
      "plans.eyebrow": "Plans",
      ...
      "plan2.benefit2": "Unlimited adjustments according to your routine and goal",
      ...
      "plan3.benefit2": "Unlimited adjustments according to your routine and goal",
      ...
      "plan4.benefit2": "Personalized training for functional rehab and safe return",
      "plan4.benefit3": "Protocols for tendinopathies and musculoskeletal pain",
      "plan4.benefit4": "Strengthening of joints, muscles, and supporting tissues",
      "plan4.benefit5": "Movement-pattern correction and prevention of new injuries",
      "plan4.benefit6": "Individual progression with close follow-up and continuous adjustments",
      "plan4.for":
      ...
      "result1.quote": '"I changed countries and continued. Taynara was the one thing that didn\'t change."',
      "result1.tag": "Online coaching · 100% natural",
      "result2.time": "8 months of coaching",
      "result2.quote": '"For the first time I saw my body truly change. And without magic formulas."',
      ...
      "result5.quote": '"I built definition and glutes I thought were impossible."',
      "result5.tag": "Hypertrophy and definition · 100% natural",
      /* Testimonials */
      "testi.eyebrow": "Testimonials",
      "testi.title": "Who trains with Tay, stays.",
      "testi1.text":
        '"I was afraid it wouldn\'t work online, but the support is so close it feels like in-person. Each adjustment is designed for me."',
      "testi1.since": "Student for 2 years",
      "testi2.text":
        '"In 6 weeks I already saw a real difference in the mirror. The consistency Tay asks for (with care) changed everything."',
      "testi2.since": "Student for 1 year",
      "testi3.text":
        '"I always thought I had no time. Taynara built a plan that fits my busy routine and I still make progress."',
      "testi3.since": "Student for 3 years",
      "testi4.text":
        '"I never felt like just another number. She responds, she follows up, she truly cares about my results."',
      ...
      "forwhom.yes.item3": "You want hypertrophy, definition or high performance naturally",
      "forwhom.yes.item4": "You need personalized coaching, not a generic spreadsheet",
      ...
      /* Footer */
      "footer.about": "High Performance Coach · Personal Trainer<br>Online · In-person · Curitiba-PR, Brazil",
  ...
  function applyLang(lang) {
    ...
    if (faqList) {
      var openTrigger = faqList.querySelector('.faq__trigger[aria-expanded="true"]');
      if (openTrigger) {
